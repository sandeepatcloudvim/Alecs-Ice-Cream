report 50004 "Sales Shipment CBR"
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalesShipmentCBR.rdl';
    ...
    dataset
    {
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem(SalesShptLine; "Integer")
                    {
                        ...
                        column(TempSalesShipmentLine; TempSalesShipmentLine.Type)
                        {
                        ...
                        begin
                            ...
                            with TempSalesShipmentLine do begin
                                ...
                                ValueEntry.Reset();
                                ValueEntry.SetRange("Document No.", TempSalesShipmentLine."Document No.");
                                ValueEntry.SetRange("Document Line No.", TempSalesShipmentLine."Line No.");
                                ValueEntry.SetRange("Item No.", TempSalesShipmentLine."No.");
            ...
            begin
                ...
                if Rec_Shipping_Agent.Get("Sales Shipment Header"."Shipping Agent Code") then;

                If Rec_Payment_terms.Get("Sales Shipment Header"."Payment Terms Code") then;
